...
class RefuseProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'RefuseNotes'  => ['required', 'string', 'max:1000'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'RefuseNotes.required' => 'Le motif du refus est requis.',
            'RefuseNotes.max'      => 'Le motif du refus ne peut pas dépasser 1000 caractères.',
        ];
    }
