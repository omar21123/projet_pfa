...
const Login = () => {
  ...
  const handleGoogleCredentialResponse = async (response: any) => {
    ...
    try {
      ...
      // Envoi de l'id_token à votre API Laravel.
      // Le backend crée/lie/connecte toujours le compte en tant que CUSTOMER.
      const authResponse = await loginWithGoogle(idToken);

      // Redirection : le backend renvoie toujours role: "CUSTOMER" pour Google,
      // mais on garde ce check au cas où la logique évolue côté serveur.
