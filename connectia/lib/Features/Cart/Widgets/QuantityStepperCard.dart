...
/// Widget non-sliver, réutilisable dans n'importe quel Column/ListView.
/// Affiche un message rouge au-dessus dès que la quantité atteint 0.
class QuantityStepperCard extends StatefulWidget {
  ...
  @override
  State<QuantityStepperCard> createState() => _QuantityStepperCardState();
}

class _QuantityStepperCardState extends State<QuantityStepperCard> {
